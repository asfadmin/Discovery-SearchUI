...
export class ProductScienceSelectorComponent implements OnInit, OnDestroy {
  ...
  sciProdGroups: sciProdGroup[] = [
...

    {
      ...
      sciProd: [
        {
          value: 'RSLC',
          viewValue: 'RSLC (Range-Doppler Single Look Complex)',
        },
        {
          value: 'RIFG',
          viewValue: 'RIFG (Range-Doppler Wrapped Interferogram)',
        },
        {
          value: 'RUNW',
          viewValue: 'RUNW (Range-Doppler Unwrapped Interferogram)',
        },
  ...
  public ngOnInit(): void {
    this.subs.add(
      this.store$.select(filtersStore.getScienceProduct).subscribe((value) => {
