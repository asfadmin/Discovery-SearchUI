...
export class TimeseriesChartComponent implements OnInit, OnDestroy {
  ...
  public ngOnInit(): void {
    ...
    this.chartData.subscribe(data => {
      this.initChart(data);
      console.log('timeseries-chart data', data);
      this.selectedSeries.push(data);
      console.log('timeseries-chart selectedSeries', this.selectedSeries);
    });
  ...
  private drawChart() {
    ...
    console.log('timeseries-chart this.dataSource', this.dataSource);
    console.log('timeseries-chart unwrapped_phases', unwrapped_phases);
    console.log('timeseries-chart dates', dates);
