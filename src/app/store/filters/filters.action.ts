...
export enum FiltersActionType {
  ...
  SET_OPERA_V3_ONLY = '[Filters] Set OPERA v3 visible only',
...
export class setOperaV3Only implements Action {
  public readonly type = FiltersActionType.SET_OPERA_V3_ONLY;
