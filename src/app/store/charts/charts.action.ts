...
export const setTimeseriesValid = createAction('[Chart] mark a timeseries aoi as invalid', props<{'wkt': string, 'valid': boolean, 'error' ?: any}>())
...
export const setFrames = createAction('[Chart] Set a series frame pieces',  props<{'wkt': string, 'frames': {[frame: string]: string}}>())