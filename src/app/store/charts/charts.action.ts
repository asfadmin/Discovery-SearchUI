...
export const removeTimeseriesState = createAction('[Chart] removes timeseries by wkt', props<{'uuid': string}>())
export const setTimeseriesChecked = createAction('[Chart] set single timeseries as checked/unchecked', props<{'uuid': string, 'checked': boolean}>())
export const setAllTimeseriesChecked = createAction('[Chart] set all timeseries as checked/unchecked', props<{'checked': boolean}>())
export const setTimeseriesColor = createAction('[Chart] set the color of a single timeseries', props<{'uuid': string, 'color': string}>())
export const setTimeseriesValid = createAction('[Chart] mark a timeseries aoi as invalid', props<{'uuid': string, 'valid': boolean, 'error' ?: any}>())
...
export const setFrames = createAction('[Chart] Set a series frame pieces',  props<{'uuid': string, 'frames': {[frame: string]: models.TimeseriesSubframe}}>())