        ...
        of({
          ...
          map(
            (wkt_response) => {
              ...
              return {
                feature,
                browse: this.browseOverlayService.createNormalImageLayer(
                  `http://127.0.0.1:8080/${this.itemsEndpoint}layers?file_name=${file}&layer=short_wavelength_displacement`,
                  wkt,
                  'ol-layer',
                  'current-overlay',
                ),
