...
export function equatorial(): MapView {
  ...
  const url = `https://api.maptiler.com/maps/hybrid/{z}/{x}/{y}.jpg?key=bFwkahiCrAA0526OlsHS`;
...
export function equatorialStreet(): MapView {
  ...
  const url = 'https://api.maptiler.com/maps/streets/{z}/{x}/{y}.png?key=bFwkahiCrAA0526OlsHS';
