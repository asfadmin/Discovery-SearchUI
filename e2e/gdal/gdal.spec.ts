...
test('Test GDAL Dropdown', { tag: '@visual' }, async ({ page }) => {
  await nisarPage(page);
  await page.getByRole('button', { name: 'Geographic Search' }).click();
  await page
    .getByRole('menuitem', { name: 'List List search allows you' })
    .click();
  await page.getByText('List of scene names').click();
  await page
  ...
  await page.getByRole('button', { name: 'L2 GCOV HDF5' }).click();
  await page.getByText('terminal_alt').first().click();
...
test('Test GDAL Dialog', { tag: '@visual' }, async ({ page }) => {
  ...
  await expect(page.locator('app-gdal-customize-dialog')).toContainText(
    'gdal_translate \\ NETCDF:"/vsicurl/https://nisar.asf.earthdatacloud.nasa.gov/NISAR/NISAR_L2_GCOV_PROVISIONAL_V1/NISAR_L2_PR_GCOV_028_128_D_076_4005_DHDH_A_20260822T021004_20260822T021029_P05023_N_P_J_001/NISAR_L2_PR_GCOV_028_128_D_076_4005_DHDH_A_20260822T021004_20260822T021029_P05023_N_P_J_001.h5"://science/LSAR/GCOV/grids/frequencyA/HVHV \\ -of GTiff "NISAR_L2_PR_GCOV_028_128_D_076_4005_DHDH_A_20260822T021004_20260822T021029_P05023_N_P_J_001__science_LSAR_GCOV_grids_frequencyA_HHHH.tif" \\ --config CPL_VSIL_CURL_CHUNK_SIZE 2097152 \\ --config CPL_VSIL_CURL_CACHE_SIZE 67108864 \\ --config GDAL_CACHEMAX 64000000 \\ --config GDAL_DISABLE_READDIR_ON_OPEN TRUE \\ --config GDAL_HTTP_MERGE_CONSECUTIVE_RANGES YES \\ --config GDAL_HTTP_MULTIPLEX YES \\ --config GDAL_NUM_THREADS ALL_CPUS \\ --config CPL_VSIL_CURL_CACHE_SIZE 1GB \\ --config GDAL_HTTP_NETRC YES \\ --config GDAL_HTTP_COOKIEFILE /tmp/gdal_cookies.txt \\ --config GDAL_HTTP_COOKIEJAR /tmp/gdal_cookies.txt',
  );
  ...
  await page.getByText('GDAL Version<').click();
  await page.getByRole('option', { name: '≥' }).click();
  await page.getByText('File FormatGTiff').click();
  await page.getByRole('option', { name: 'COG' }).click();
  await expect(page.locator('app-gdal-customize-dialog')).toContainText(
    'gdal_translate \\ NETCDF:"/vsicurl/https://nisar.asf.earthdatacloud.nasa.gov/NISAR/NISAR_L2_GCOV_PROVISIONAL_V1/NISAR_L2_PR_GCOV_028_128_D_076_4005_DHDH_A_20260822T021004_20260822T021029_P05023_N_P_J_001/NISAR_L2_PR_GCOV_028_128_D_076_4005_DHDH_A_20260822T021004_20260822T021029_P05023_N_P_J_001.h5"://science/LSAR/GCOV/grids/frequencyA/HVHV \\ -of COG "NISAR_L2_PR_GCOV_028_128_D_076_4005_DHDH_A_20260822T021004_20260822T021029_P05023_N_P_J_001__science_LSAR_GCOV_grids_frequencyA_HHHH.tif" \\ --config CPL_VSIL_CURL_CHUNK_SIZE 2097152 \\ --config CPL_VSIL_CURL_CACHE_SIZE 67108864 \\ --config GDAL_CACHEMAX 64000000 \\ --config GDAL_DISABLE_READDIR_ON_OPEN TRUE \\ --config GDAL_HTTP_MERGE_CONSECUTIVE_RANGES YES \\ --config GDAL_HTTP_MULTIPLEX YES \\ --config GDAL_NUM_THREADS ALL_CPUS \\ --config CPL_VSIL_CURL_CACHE_SIZE 1GB \\ --config GDAL_HTTP_NETRC YES \\ --config GDAL_HTTP_COOKIEFILE /tmp/gdal_cookies.txt \\ --config GDAL_HTTP_COOKIEJAR /tmp/gdal_cookies.txt',
  );

  await page.getByText('File FormatCOG').click();
  await page.getByRole('option', { name: 'GTiff' }).click();
  await page.getByText('Operating SystemUnix').click();
  await page.getByRole('option', { name: 'Windows' }).click();
  await expect(page.locator('app-gdal-customize-dialog')).toContainText(
    'gdal_translate ^ NETCDF:"/vsicurl/https://nisar.asf.earthdatacloud.nasa.gov/NISAR/NISAR_L2_GCOV_PROVISIONAL_V1/NISAR_L2_PR_GCOV_028_128_D_076_4005_DHDH_A_20260822T021004_20260822T021029_P05023_N_P_J_001/NISAR_L2_PR_GCOV_028_128_D_076_4005_DHDH_A_20260822T021004_20260822T021029_P05023_N_P_J_001.h5"://science/LSAR/GCOV/grids/frequencyA/HVHV ^ -of GTiff "NISAR_L2_PR_GCOV_028_128_D_076_4005_DHDH_A_20260822T021004_20260822T021029_P05023_N_P_J_001__science_LSAR_GCOV_grids_frequencyA_HHHH.tif" ^ --config CPL_VSIL_CURL_CHUNK_SIZE 2097152 ^ --config CPL_VSIL_CURL_CACHE_SIZE 67108864 ^ --config GDAL_CACHEMAX 64000000 ^ --config GDAL_DISABLE_READDIR_ON_OPEN TRUE ^ --config GDAL_HTTP_MERGE_CONSECUTIVE_RANGES YES ^ --config GDAL_HTTP_MULTIPLEX YES ^ --config GDAL_NUM_THREADS ALL_CPUS ^ --config CPL_VSIL_CURL_CACHE_SIZE 1GB ^ --config GDAL_HTTP_NETRC YES ^ --config GDAL_HTTP_COOKIEFILE %TEMP%/gdal_cookies.txt ^ --config GDAL_HTTP_COOKIEJAR %TEMP%/gdal_cookies.txt',
  );

  await page.getByText('Operating SystemWindows').click();
  await page.getByRole('option', { name: 'Unix' }).click();
  await page.getByText('Output Projection').click();
  await page.getByRole('textbox', { name: 'Output Projection' }).fill('WGS84');
  await expect(page.locator('app-gdal-customize-dialog')).toContainText(
    'gdalwarp \\ NETCDF:"/vsicurl/https://nisar.asf.earthdatacloud.nasa.gov/NISAR/NISAR_L2_GCOV_PROVISIONAL_V1/NISAR_L2_PR_GCOV_028_128_D_076_4005_DHDH_A_20260822T021004_20260822T021029_P05023_N_P_J_001/NISAR_L2_PR_GCOV_028_128_D_076_4005_DHDH_A_20260822T021004_20260822T021029_P05023_N_P_J_001.h5"://science/LSAR/GCOV/grids/frequencyA/HVHV \\ -of GTiff "NISAR_L2_PR_GCOV_028_128_D_076_4005_DHDH_A_20260822T021004_20260822T021029_P05023_N_P_J_001__science_LSAR_GCOV_grids_frequencyA_HHHH.tif" \\ -t_srs WGS84 \\ -dstalpha \\ --config CPL_VSIL_CURL_CHUNK_SIZE 2097152 \\ --config CPL_VSIL_CURL_CACHE_SIZE 67108864 \\ --config GDAL_CACHEMAX 64000000 \\ --config GDAL_DISABLE_READDIR_ON_OPEN TRUE \\ --config GDAL_HTTP_MERGE_CONSECUTIVE_RANGES YES \\ --config GDAL_HTTP_MULTIPLEX YES \\ --config GDAL_NUM_THREADS ALL_CPUS \\ --config CPL_VSIL_CURL_CACHE_SIZE 1GB \\ --config GDAL_HTTP_NETRC YES \\ --config GDAL_HTTP_COOKIEFILE /tmp/gdal_cookies.txt \\ --config GDAL_HTTP_COOKIEJAR /tmp/gdal_cookies.txt',
  );
  ...
  await page.getByText('~/.gdal/gdalrc file_copy').click();
  await expect(page.locator('app-gdal-customize-dialog')).toContainText(
  ...
  await page
    .getByRole('textbox', { name: 'Output Filename' })
    .fill('output.tif');
  await page.getByRole('textbox', { name: 'Output Filename' }).press('Enter');
  await expect(page.locator('app-gdal-customize-dialog')).toContainText(
